...
const DEPT_KEYWORDS: Record<string, string[]> = {
  dev: ["開発", "コーディング", "フロント", "バックエンド", "API", "サーバー", "コード", "バグ", "プログラム", "アプリ", "ウェブ"],
  design: ["デザイン", "UI", "UX", "モックアップ", "Figma", "アイコン", "ロゴ", "バナー", "レイアウト", "デザイン案"],
  planning: ["企画", "戦略", "分析", "リサーチ", "報告書", "PPT", "発表", "市場", "調査", "提案"],
  operations: ["運営", "デプロイ", "インフラ", "モニタリング", "サーバー管理", "CI", "CD", "DevOps", "障害"],
  qa: ["QA", "QC", "品質", "テスト", "検収", "バグレポート", "回帰", "自動化テスト", "性能テスト", "レビュー"],
  devsecops: [
    "セキュリティ",
    "脆弱性",
    "認証",
